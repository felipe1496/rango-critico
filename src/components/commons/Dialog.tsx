  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <RadixDialog.Content
        ...
        className={cn(
          "bg-background fixed top-[50%] left-[50%] z-50 grid w-full max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] rounded-sm shadow-lg duration-200 sm:max-w-lg",
          className
        )}
        {...props}
      >
...
export const DialogFooter = ({
  ...
  return (
    <div
      ...
      className={cn(
        "flex flex-col-reverse gap-2 p-2 bg-zinc-100 sm:flex-row sm:justify-end rounded-sm",
        className
      )}
      {...props}
    />
