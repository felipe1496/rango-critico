...
export default function HomePage() {
	...
	return (
		<main className="flex items-center justify-center flex-col px-4 pb-4">
			<div className="max-w-4xl w-full">
				<section className="flex flex-col gap-4 text-center items-center">
					<h1 className="font-title text-4xl mt-8">
				...
				<section className="flex flex-col mt-12">
					<div className="flex w-full justify-between">
						<h2 className="font-title text-2xl font-bold translate-y-[6px]">
							Críticas
						</h2>
